...
class Network(nn.Module):
    ...
    def __init__(self, channel=32, imagenet_pretrained=True):
        ...
        pretrained_dict = torch.load('E:/COD/pvt_v2_b4.pth')
        ...
        self.PPMHEAD2 = PPMHEAD(in_channels=128, out_channels=channel, pool_sizes = [8, 16, 32, 64])
        self.PPMHEAD3 = PPMHEAD(in_channels=320, out_channels=channel, pool_sizes = [4, 8, 16, 32])
        self.PPMHEAD4 = PPMHEAD(in_channels=512, out_channels=channel, pool_sizes = [2, 4, 8, 16])
