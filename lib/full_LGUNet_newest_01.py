...
class Network(nn.Module):
    ...
    def __init__(self, channel=32, imagenet_pretrained=True):
        ...
        self.PPMHEAD2 = PPMHEAD(channel, channel, pool_sizes = [8, 16, 32, 64])
        self.PPMHEAD3 = PPMHEAD(channel, channel, pool_sizes = [4, 8, 16, 32])
        self.PPMHEAD4 = PPMHEAD(channel, channel, pool_sizes = [2, 4, 8, 16])
