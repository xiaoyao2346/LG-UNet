...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='/root/autodl-tmp/Dataset/TestDataset')
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        # default=['Exp-DGNet-PVTv2-B0', 'Exp-DGNet-PVTv2-B1', 'Exp-DGNet', 'Exp-DGNet-S','Exp-DGNet-PVTv2-B4-01'])
        # default=['Exp-DGNet-PVTv2-B4-02'])
        default=['full_LGUNet_new','full_LGUNet_newest_02','LGUNet_LU_02','LGUNet_PPM_02'])
        # default=['Exp-DGNet-S', 'Exp-DGNet', 'Exp-DGNet-PVTv2-B0', 'Exp-DGNet-PVTv2-B1', 'Exp-DGNet-PVTv2-B2', 'Exp-DGNet-PVTv2-B3', 'Exp-DGNet-PVTv2-B4'])
