...
from lib.LG_UNet import Network
...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    try:
        for i, (images, gts) in enumerate(train_loader, start=1):
            ...
            preds = model(images)
            loss_init = 2.5 * structure_loss(preds[0], gts) + structure_loss(preds[1], gts) + 0.5 * structure_loss(preds[2], gts)
            loss_final = 6* structure_loss(preds[3], gts)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='/root/autodl-tmp/Dataset/TrainDataset/',
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default='/root/autodl-tmp/Dataset/TestDataset/COD10K/',
                        help='the test rgb images root')
    parser.add_argument('--save_path', type=str,
                        default='./snapshot/LG-UNet/',
