...
parser.add_argument("--dataset_name", type=str, default='ETIS', 
                    help="path to the prediction results")
parser.add_argument("--pred_path", type=str, default='/root/autodl-tmp/xiaoyao_code/LGUNet/res/Polyp2/ETIS/' ,
                    help="path to the prediction results")
parser.add_argument("--gt_path", type=str, default='/root/autodl-tmp/Dataset/PolypDataset/ETIS/GT/',
